...
class OfficeModel extends CI_Model {
    ...
    {
        $this->db->select('pemohon_iuts.nama,pemohon_iuts.email,bangunan_iuts.code,bangunan_iuts.no_reg_bangunan,bangunan_iuts.nop,bangunan_iuts.alamat,bangunan_iuts.status,bangunan_iuts.nib,pemohon_iuts.npwp,bangunan_iuts.created_at,bangunan_iuts.zona,bangunan_iuts.kode_sublok,bangunan_iuts.lat,bangunan_iuts.lon');
        $this->db->from('bangunan_iuts');
