...
class OfficeModel extends CI_Model {
	...
	function InsertAdminDinasBaru($bangunan,$admin,$keterangan,$status,$skor,$skorslf,$skoriuts)
	{
		$arrayPermohonan = array(
            'id_izin'=>$bangunan,
			'id_admin' => $admin,
