...
<!-- 						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
						...
						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
							<tr>
								<td colspan="3">
									<h4 style="margin:0;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.87);font-size:16px;line-height:1.8">Data Login</h4>
								</td>
							</tr>
							<tr>
								<td>Email</td><td style="width: 20px">:</td><td><?=$data->email?></td>
							</tr>
							<tr>
								<td>Password</td><td style="width: 20px">:</td><td><?=$data->token?> </td>
							</tr>
						</table>
                        <!-- Buat Pemohon baru -->
						</div>
