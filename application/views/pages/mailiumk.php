				...
				<td style="box-shadow: 0 0 15px 2px rgba(0,0,0,.4);">
					<div style="word-break:break-word">
						...
						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
							...
							<center>
								<a href="https://iuts.pkkmart.com/verifikasi.html">
								<button style="cursor:pointer;background: #335589;height:auto;padding:20px;width:auto;border: none;border-radius: 2px;color:#f9f9f9;box-shadow: 0 0 8px 2px rgba(0,0,0,0.2)">Verifikasi Sekarang!</button>
							</a>
						</center>
...
<!-- 						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
						...
						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
							<tr>
								<td colspan="3">
									<h4 style="margin:0;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.87);font-size:16px;line-height:1.8">Verifikasi</h4>
								</td>
							</tr>
							<tr>
								<td>Token Verifikasi</td><td style="width: 20px">:</td><td><?=$data->code?> </td>
							</tr>
						</table>
                        <!-- Buat Pemohon baru -->
						</div>
