				...
				<td style="box-shadow: 0 0 15px 2px rgba(0,0,0,.4);">
					<div style="word-break:break-word">
						...
						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
							<tr>
								<td colspan="3">
									<h4 style="margin:0;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:#ff6704;font-size:16px;line-height:1.8">Halo <?=$data->nama?>,</h4>
								</td>
							</tr>
						</table>
							<center>
							...
							<div style="background:rgba(245, 245, 245, 1);text-align:center;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;padding-left:20px;padding-right:20px;color:rgba(97, 84, 84, 0.87);font-size:14px;padding-bottom:8px;padding-top:5px;margin:20px 0;">Mohon jangan berikan password pada siapapun
							</div>
...
<!-- 						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
						...
						<div style="border:solid 1px rgba(0,0,0,.2);margin-top: 10px !important;padding:10px;margin-top:10px;">
							<?php if ($data->status == 4) { ?>
								<h4 style="margin:0;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.87);font-size:16px;line-height:1.8">Selamat Data Anda Di Terima Oleh Kepala Dinas DPMPTSP, Silakan Menunggu Intruksi Selajutnya</h4>
						...
						<table style="border:solid 1px rgba(0,0,0,.2);width:100%;padding:10px;margin-top:10px;word-break: break-all;word-wrap:break-word;">
							...
							<tr>
								<td>Kode</td><td style="width: 20px">:</td><td><?=$data->token?> </td>
							</tr>
						</table>
                        <!-- Buat Pemohon baru -->
						</div>
